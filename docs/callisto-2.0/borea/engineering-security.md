...
## Nguyên tắc bảo mật
Borea tuân thủ SOC 2 Type II, PCI-DSS Level 1, ISO 27001. Zero Trust architecture toàn bộ stack. Security team 8 người báo cáo trực tiếp CISO. Security là blocker cho mọi release.
...
## Bảo mật ứng dụng
OWASP ASVS Level 2 compliance. SAST (Semgrep), DAST (ZAP), SCA (Snyk) trong CI — block merge nếu có finding Critical/High. Penetration testing 2 lần/năm (HackerOne). Bug bounty: $100–$25,000 trên HackerOne.
...
## Đào tạo bảo mật
Security Champion program: 1 champion/team, train 8 giờ/quý. Phishing simulation hằng tháng (target dưới 2%). Capture The Flag (CTF) hằng quý cho engineering. Secure coding certification bắt buộc cho engineer mới.
...
## Compliance
SOC 2 Type II (audit liên tục bởi Vanta). PCI-DSS Level 1 (audit hằng năm bởi QSA). ISO 27001 certified. PDPA và GDPR compliance. Annual compliance report cho Board. Customer audit questionnaire response SLA: 5 ngày.
