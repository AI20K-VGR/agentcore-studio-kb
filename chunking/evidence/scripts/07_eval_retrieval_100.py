...
async def main() -> None:
    ...
    for cfg in CONFIGS:
        (BENCH / f"retrieval_results_100q_{cfg}.json").write_text(
    ...
    (BENCH / "retrieval_summary_100q.json").write_text(json.dumps(summary, ensure_ascii=False, indent=2), encoding="utf-8")
