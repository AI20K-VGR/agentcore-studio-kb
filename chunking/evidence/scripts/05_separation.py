...
async def main() -> None:
    ...
    per_query: dict[str, list[dict[str, Any]]] = {cfg: [] for cfg in CONFIGS}
    ...
    (BENCH / "separation_summary.json").write_text(json.dumps(summary, ensure_ascii=False, indent=2), encoding="utf-8")
    for cfg in CONFIGS:
        (BENCH / f"separation_detail_{cfg}.json").write_text(
